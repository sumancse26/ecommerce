...
<script>
    async function CartList() {
        let res = await axios.get(`/get-cart-list`);
        $("#byList").empty();

        res.data.cartList.forEach((item, i) => {
            let EachItem = `<tr>
        ...
        await cartTotal(res.data.cartList);
    ...
    async function removeCartList(id) {
        ...
        let res = await axios.delete("/remove-cart/" + id);
    ...
    async function CheckOut() {
        ...
        if (res.data.success) {
            ...
            res.data.paymentMethods?.forEach((item, i) => {
                let EachItem = `<tr>
