...
<script>
    async function profileCreate() {
        ...
        let res = await axios.post("/create-update-profile", postBody);
    ...
    async function profileDetails() {
        ...
        let res = await axios.get("/get-profile");
        if (res.data.userInfo !== null) {

            document.getElementById('cus_name').value = res.data.userInfo.cus_name
            document.getElementById('cus_add').value = res.data.userInfo.cus_add
            document.getElementById('cus_city').value = res.data.userInfo.cus_city
            document.getElementById('cus_state').value = res.data.userInfo.cus_state
            document.getElementById('cus_postcode').value = res.data.userInfo.cus_postcode
            document.getElementById('cus_phone').value = res.data.userInfo.cus_phone
            document.getElementById('cus_country').value = res.data.userInfo.cus_country
            document.getElementById('cus_fax').value = res.data.userInfo.cus_fax
            document.getElementById('ship_name').value = res.data.userInfo.ship_name
            document.getElementById('ship_add').value = res.data.userInfo.ship_add
            document.getElementById('ship_city').value = res.data.userInfo.ship_city
            document.getElementById('ship_state').value = res.data.userInfo.ship_state
            document.getElementById('ship_postcode').value = res.data.userInfo.ship_postcode
            document.getElementById('ship_country').value = res.data.userInfo.ship_country
            document.getElementById('ship_phone').value = res.data.userInfo.ship_phone
